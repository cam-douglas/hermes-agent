...
from hermes_state_archive_notices import SessionArchiveNoticesMixin
...
class SessionDB(
    ...
    SessionMessagesMixin, SessionRewindMixin, SessionProfileRepairMixin, SessionArchiveNoticesMixin,
):
