...
import { resolveHermesInvocation, type HermesInvocation } from "./resolve-hermes.js";
...
export async function testEnvironment(
  ...
  if (pythonCheck) {
    const downgradeNonBlocking =
      inv.argsPrefix.length === 0 &&
