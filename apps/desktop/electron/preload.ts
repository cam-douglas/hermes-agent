...
contextBridge.exposeInMainWorld('hermesDesktop', {
  ...
  playChime: () => ipcRenderer.invoke('hermes:play-chime'),
  ...
  desktopChromeRoot: () => ipcRenderer.invoke('hermes:fs:desktopChromeRoot'),
  desktopChromeSnapshot: () => ipcRenderer.invoke('hermes:chrome:snapshot'),
  desktopChromeRollback: () => ipcRenderer.invoke('hermes:chrome:rollback'),
